#ifndef USE_AFTER_FREE_ANALYSIS_H
#define USE_AFTER_FREE_ANALYSIS_H
...
struct UseAfterFreeAnalysis : public PassInfoMixin<UseAfterFreeAnalysis> {
  static char ID;
 ...
 protected:
  ...
  /**
   * Can the Instruction Inst incurr a use-after-free error?
   *
   * @param Inst Instruction to check.
   * @return true if the instruction can incur a use-after-free error.
   */
...
#endif  // USE_AFTER_FREE_ANALYSIS_H
